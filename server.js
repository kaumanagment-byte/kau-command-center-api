...
const ADS_BASE_URL = process.env.ADS_BASE_URL || "http://127.0.0.1:8123";
const INTELLIGENCE_BASE_URL = process.env.INTELLIGENCE_BASE_URL || "http://127.0.0.1:8899";
const CRM_BASE_URL = process.env.CRM_BASE_URL || "http://localhost:8787";
